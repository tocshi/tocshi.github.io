            ...
            <div className="items-container">
                ...
                <VerticalTimeline>
                    ...
                    >
                        ...
                        <p>Full-stack Web Development, UI/UX Development, Software Testing</p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        className="vertical-timeline-element--work"
                    ...
                    >
                        ...
                        <p>Software Testing, Automated Testing</p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        className="vertical-timeline-element--work"
                    ...
                    >
                        ...
                        <p>Software Testing, Agile Development, Exploratory Testing</p>
                    </VerticalTimelineElement>
                </VerticalTimeline>
            </div>
        </div>
